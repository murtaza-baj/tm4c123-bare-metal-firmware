...
#define SYSCTL_RCC2_OSCSRC2_MASK  (0x7 << 4)  // MOSC
#define SYSCTL_RCC2_PWRDN2      (1U << 13)  // Power-Down PLL 2
#define SYSCTL_RCC2_SYSDIV_80MHz     (4 << 23) // System Clock Divisor
...
#define NVIC_ST_CTRL_ENABLE   (1U << 0)   // counter enable
#define NVIC_ST_CTRL_INTEN    (1U << 1)   // interrupt enable
#define NVIC_ST_CTRL_CLK_SRC  (1U << 2)   // clock source: 1 = system clock
//---------------------------Interrupts------------------------------------//
